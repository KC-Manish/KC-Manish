...
#endif
            VL_FATAL_MT("fifo.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vfifo___024root___ctor_var_reset(Vfifo___024root* vlSelf) {
    ...
    vlSelf->fifo__DOT__wr_ptr = VL_RAND_RESET_I(3);
    vlSelf->fifo__DOT__rd_ptr = VL_RAND_RESET_I(3);
    vlSelf->fifo__DOT__count = VL_RAND_RESET_I(4);
