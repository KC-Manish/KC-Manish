...
VL_INLINE_OPT void Vfifo___024root___nba_sequent__TOP__0(Vfifo___024root* vlSelf) {
    ...
    // Init
    CData/*2:0*/ __Vdly__fifo__DOT__wr_ptr;
    __Vdly__fifo__DOT__wr_ptr = 0;
    CData/*2:0*/ __Vdlyvdim0__fifo__DOT__mem__v0;
    ...
    CData/*2:0*/ __Vdly__fifo__DOT__rd_ptr;
    __Vdly__fifo__DOT__rd_ptr = 0;
    CData/*3:0*/ __Vdly__fifo__DOT__count;
    __Vdly__fifo__DOT__count = 0;
    // Body
    __Vdly__fifo__DOT__rd_ptr = vlSelf->fifo__DOT__rd_ptr;
    __Vdly__fifo__DOT__wr_ptr = vlSelf->fifo__DOT__wr_ptr;
    __Vdlyvset__fifo__DOT__mem__v0 = 0U;
    __Vdly__fifo__DOT__count = vlSelf->fifo__DOT__count;
    if (vlSelf->rst) {
        ...
        if (((IData)(vlSelf->write_en) & (~ (IData)(vlSelf->full)))) {
            __Vdlyvval__fifo__DOT__mem__v0 = vlSelf->data_in;
            __Vdlyvset__fifo__DOT__mem__v0 = 1U;
            __Vdlyvdim0__fifo__DOT__mem__v0 = vlSelf->fifo__DOT__wr_ptr;
            __Vdly__fifo__DOT__wr_ptr = ((7U == (IData)(vlSelf->fifo__DOT__wr_ptr))
                                          ? 0U : (7U 
                                                  & ((IData)(1U) 
                                                     + (IData)(vlSelf->fifo__DOT__wr_ptr))));
            __Vdly__fifo__DOT__count = (0xfU & ((IData)(1U) 
                                                + (IData)(vlSelf->fifo__DOT__count)));
        }
        if (((IData)(vlSelf->read_en) & (~ (IData)(vlSelf->empty)))) {
            __Vdly__fifo__DOT__count = (0xfU & ((IData)(vlSelf->fifo__DOT__count) 
                                                - (IData)(1U)));
            vlSelf->data_out = vlSelf->fifo__DOT__mem
                [vlSelf->fifo__DOT__rd_ptr];
            __Vdly__fifo__DOT__rd_ptr = ((7U == (IData)(vlSelf->fifo__DOT__rd_ptr))
                                          ? 0U : (7U 
                                                  & ((IData)(1U) 
                                                     + (IData)(vlSelf->fifo__DOT__rd_ptr))));
        }
    }
    vlSelf->fifo__DOT__wr_ptr = __Vdly__fifo__DOT__wr_ptr;
    vlSelf->fifo__DOT__count = __Vdly__fifo__DOT__count;
    vlSelf->fifo__DOT__rd_ptr = __Vdly__fifo__DOT__rd_ptr;
    if (__Vdlyvset__fifo__DOT__mem__v0) {
        vlSelf->fifo__DOT__mem[__Vdlyvdim0__fifo__DOT__mem__v0] 
            = __Vdlyvval__fifo__DOT__mem__v0;
    }
    vlSelf->full = (8U == (IData)(vlSelf->fifo__DOT__count));
    vlSelf->empty = (0U == (IData)(vlSelf->fifo__DOT__count));
}
...
#endif
            VL_FATAL_MT("fifo.sv", 3, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("fifo.sv", 3, "", "Active region did not converge.");
            }
